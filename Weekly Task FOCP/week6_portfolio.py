...
positive_num= 77
binary_num = decimal_to_binary(positive_num)
print('==================================')
print(f"The binary representation of {positive_num} is: {binary_num}")
print('==================================')
...
# Testing the function
print(encrypt_message("My name is Manjusha Shrestha"))
print('==================================')
